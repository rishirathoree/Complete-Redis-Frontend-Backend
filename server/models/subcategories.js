...
module.exports = (sequelize, DataTypes) => {
  class subcategories extends Model {
    ...
    static associate(models) {
      ...
      subcategories.belongsToMany(models.products, { through: models.productsjunctions, foreignKey: "subcategoryId" });
      subcategories.hasMany(models.productsjunctions, { foreignKey: "subcategoryId" })
    }
  }
  subcategories.init({
    id: {
