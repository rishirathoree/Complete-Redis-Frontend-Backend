                                    ...
                                    {data && data.map((item) => {
                                        return (
                                            <motion.tr key={item.id} className={`divide-x`}>
                                                ...
                                                <Tooltip side='bottom' showArrow={false} className='text-[10px]' content={item.name}>
                                                    <img src={item.image} className='object-cover size-8 rounded-md' crossOrigin='anonymous' alt="" />
                                                </Tooltip>
                                                </motion.td>
                                                <motion.td className="px-6 py-2 w-1/6 text-sm font-medium text-gray-800">
                                                    <div className="flex items-center gap-2">
                                                        <p className='capitalize line-clamp-1'>{item.name}</p>
                                                    </div>
                                                </motion.td>
                                                <motion.td className="px-6 py-2 w-1/6 text-sm font-medium text-gray-800">
                                                    <div className="flex items-center gap-2">
                                                        <p className='capitalize line-clamp-1'>{item.productCount}</p>
                                                    </div>
                                                </motion.td>
                                                <motion.td className="px-6 py-2 w-1/6 text-sm font-medium text-gray-800">
                                                    <div className="flex items-center gap-2">
                                                ...
                                                <motion.td className="px-6 py-2 w-1/6 text-sm font-medium text-gray-800">
                                                    <div className="flex items-center gap-2">
                                                        <Tooltip
                                                            ...
                                                            className='text-[10px]'
                                                            side='top'
                                                            content={item.blocked ? 'Currently, breeds are not visible to shop' : 'Currently, breeds are visible to shop'}
                                                        >
                                                            <Badges
