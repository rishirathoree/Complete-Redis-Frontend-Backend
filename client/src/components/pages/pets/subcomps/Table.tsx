                                                ...
                                                <motion.td className="px-6 py-2 w-1/6 text-sm font-medium text-gray-800">
                                                    <div className="flex  -space-x-2">
                                                        {item.breeds.map((item) => {
                                                            return (
                                                                <Tooltip showArrow={false} className='text-[10px]' side='top' content={`${item.name}`}>
                                                                    <img src={item.image} className='object-cover ring-2 ring-white size-8 rounded-full' crossOrigin='anonymous' alt="" />
                                                                </Tooltip>
                                                            )
                                                        })}
                                                    </div>
